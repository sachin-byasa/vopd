                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email_id" type="email_id" class="form-control @error('email_id') is-invalid @enderror" name="email_id" value="{{ old('email_id') }}" required autocomplete="email_id">
                        ...
                        <div class="form-group row">
                            <label for="user_key" class="col-md-4 col-form-label text-md-right">{{ __('Password') }}</label>

                            <div class="col-md-6">
                                <input id="user_key" type="user_key" class="form-control @error('user_key') is-invalid @enderror" name="user_key" required autocomplete="new-user_key">
                        ...
                        <div class="form-group row">
                            <label for="user_key-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}</label>

                            <div class="col-md-6">
                                <input id="user_key-confirm" type="user_key" class="form-control" name="user_key_confirmation" required autocomplete="new-user_key">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="mobile_number" class="col-md-4 col-form-label text-md-right">User Type</label>
